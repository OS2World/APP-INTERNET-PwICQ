...
rem   icqtext.exe --uin=6838492 --password=oxigenio --save --plugins=0 --inifile=w:\data\ibmcpp\sources\icq2\config\pwicq.ini --plugins=0 --config-files=w:\data\ibmcpp\sources\icq2\config\ --module=w:\data\ibmcpp\sources\icq2\plugins\icqpmdc\icqpmdc.dll

   start pwicq2.exe --uin=6838492 --inifile=w:\data\ibmcpp\sources\icq2\config\pwicq.ini --debug=w:\temp\pwicq.dbg --log=w:\temp\pwicq.log --plugins=0 --config-files=w:\data\ibmcpp\sources\icq2\config\ --module=plugins\icqskmgr.dll --module=plugins\icqconf.dll --module=w:\data\ibmcpp\sources\icq2\plugins\miniwin\icqminiw.dll --module=plugins\icqv8.dll
